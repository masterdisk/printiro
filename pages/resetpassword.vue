    ...
    <div class="w-full max-w-md p-6 space-y-6 bg-white rounded-lg shadow-lg">
      ...
      <form class="space-y-4" @submit.prevent="changePassword">
        <div>
          ...
          <input
            id="password" v-model="password" type="password" class="w-full p-2 border border-gray-400 rounded-md"
        ...
        <div>
          ...
          <input
            id="confirmPassword" v-model="confirmPassword" type="password" class="w-full p-2 border border-gray-400 rounded-md"
