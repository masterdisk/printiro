            ...
            <DialogPanel class="relative flex w-full max-w-xs flex-1 flex-col bg-white pt-5 pb-4">
              ...
              <div class="mt-5 h-0 flex-1 overflow-y-auto">
                <nav class="px-2">
                  ...
                  <div class="mt-8">
                    <h3 id="mobile-teams-headline" class="px-3 text-sm font-medium text-gray-500">
                      Teams
                    </h3>
      ...
      <div class="mt-5 flex h-0 flex-1 flex-col overflow-y-auto pt-1">
        ...
        <div class="mt-5 px-3">
          ...
          <div class="relative mt-1 rounded-md shadow-sm">
            ...
            <input id="search" type="text" name="search" class="block w-full rounded-md border-gray-300 pl-9 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Search">
          </div>
        </div>
        <!-- Navigation -->
        <nav class="mt-6 px-3">
          ...
          <div class="mt-8">
            ...
            <h3 id="desktop-teams-headline" class="px-3 text-sm font-medium text-gray-500">
              Teams
            </h3>
      ...
      <main class="flex-1">
        ...
        <div class="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
          ...
          <div class="mt-4 flex sm:mt-0 sm:ml-4">
            <button type="button" class="sm:order-0 order-1 ml-3 inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 sm:ml-0">
              Share
            </button>
            <button type="button" class="order-0 inline-flex items-center rounded-md border border-transparent bg-purple-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 sm:order-1 sm:ml-3">
              Create
            </button>
          </div>
        </div>
