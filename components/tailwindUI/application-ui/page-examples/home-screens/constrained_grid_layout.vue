...
<template>
  ...
  <div class="min-h-full">
    <Popover v-slot="{ open }" as="header" class="bg-gradient-to-r from-sky-800 to-cyan-600 pb-24">
            ...
            <div class="lg:grid lg:grid-cols-3 lg:items-center lg:gap-8">
              ...
              <div class="hidden lg:col-span-2 lg:block">
                <nav class="flex space-x-4">
                  <a v-for="item in navigation" :key="item.name" :href="item.href" class="text-sm font-medium rounded-md bg-white bg-opacity-0 px-3 py-2 hover:bg-opacity-10" :class="[item.current ? 'text-white' : 'text-cyan-100']" :aria-current="item.current ? 'page' : undefined">{{ item.name }}</a>
                </nav>
              </div>
        ...
        <div class="grid grid-cols-1 items-start gap-4 lg:grid-cols-3 lg:gap-8">
          ...
          <div class="grid grid-cols-1 gap-4 lg:col-span-2">
            ...
            <section aria-labelledby="quick-links-title">
              <div class="divide-y divide-gray-200 overflow-hidden rounded-lg bg-gray-200 shadow sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0">
                ...
                <div v-for="(action, actionIdx) in actions" :key="action.name" class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500" :class="[actionIdx === 0 ? 'rounded-tl-lg rounded-tr-lg sm:rounded-tr-none' : '', actionIdx === 1 ? 'sm:rounded-tr-lg' : '', actionIdx === actions.length - 2 ? 'sm:rounded-bl-lg' : '', actionIdx === actions.length - 1 ? 'rounded-bl-lg rounded-br-lg sm:rounded-bl-none' : '']">
                  <div>
          ...
          <div class="grid grid-cols-1 gap-4">
            ...
            <section aria-labelledby="announcements-title">
              <div class="overflow-hidden rounded-lg bg-white shadow">
                <div class="p-6">
                  <h2 id="announcements-title" class="text-base font-medium text-gray-900">
                    Announcements
                  </h2>
            ...
            <section aria-labelledby="recent-hires-title">
              <div class="overflow-hidden rounded-lg bg-white shadow">
                <div class="p-6">
                  <h2 id="recent-hires-title" class="text-base font-medium text-gray-900">
                    Recent Hires
                  </h2>
                  <div class="mt-6 flow-root">
                    <ul role="list" class="-my-5 divide-y divide-gray-200">
