    ...
    <div>
      ...
      <form class="mt-6 sm:flex sm:items-center" action="#">
        ...
        <div class="relative rounded-md shadow-sm sm:min-w-0 sm:flex-1">
          <input id="emails" type="text" name="emails" class="block w-full rounded-md border-gray-300 pr-32 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Enter an email">
        ...
        <div class="mt-3 sm:mt-0 sm:ml-4 sm:flex-shrink-0">
          <button type="submit" class="block w-full rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-center text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            Send invite
          </button>
        </div>
      </form>
