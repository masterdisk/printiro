    ...
    <TabGroup v-slot="{ selectedIndex }">
      <TabList class="flex items-center">
        <Tab v-slot="{ selected }" as="template">
          <button class="rounded-md border border-transparent px-3 py-1.5 text-sm font-medium" :class="[selected ? 'text-gray-900 bg-gray-100 hover:bg-gray-200' : 'text-gray-500 hover:text-gray-900 bg-white hover:bg-gray-100']">
            Write
          </button>
        </Tab>
        <Tab v-slot="{ selected }" as="template">
          <button class="ml-2 rounded-md border border-transparent px-3 py-1.5 text-sm font-medium" :class="[selected ? 'text-gray-900 bg-gray-100 hover:bg-gray-200' : 'text-gray-500 hover:text-gray-900 bg-white hover:bg-gray-100']">
            Preview
          </button>
        </Tab>
      ...
      <TabPanels class="mt-2">
        <TabPanel class="-m-0.5 rounded-lg p-0.5">
          ...
          <div>
            <textarea id="comment" rows="5" name="comment" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Add your comment..." />
          </div>
        </TabPanel>
        <TabPanel class="-m-0.5 rounded-lg p-0.5">
          <div class="border-b">
