          ...
          <div class="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2 lg:gap-8">
            <div v-for="tier in tiers" :key="tier.name" class="flex flex-col rounded-3xl bg-white shadow-xl ring-1 ring-black/10">
              <div class="p-8 sm:p-10">
                <h3 :id="tier.id" class="text-lg font-semibold leading-8 tracking-tight text-indigo-600">
                  {{ tier.name }}
                </h3>
              ...
              <div class="flex flex-1 flex-col p-2">
                <div class="flex flex-1 flex-col justify-between rounded-2xl bg-gray-50 p-6 sm:p-8">
                  ...
                  <div class="mt-8">
                    <a :href="tier.href" class="inline-block w-full rounded-lg bg-indigo-600 px-4 py-2.5 text-center text-sm font-semibold leading-5 text-white shadow-md hover:bg-indigo-700" :aria-describedby="tier.id">Get started today</a>
                  </div>
                </div>
              </div>
            </div>
