...
<template>
  <div class="bg-white">
          ...
          <div class="flex items-center justify-between border-b border-indigo-400 border-opacity-25 py-6 md:justify-start md:space-x-10">
            ...
            <PopoverGroup as="nav" class="hidden space-x-10 md:flex">
              <Popover v-slot="{ open }" class="relative">
                <PopoverButton class="group inline-flex items-center rounded-md bg-indigo-900 text-base font-medium hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-900" :class="[open ? 'text-white' : 'text-indigo-300']">
                  <span>Solutions</span>
                  <ChevronDownIcon class="ml-2 h-5 w-5 group-hover:text-white" :class="[open ? 'text-white' : 'text-indigo-300']" aria-hidden="true" />
                </PopoverButton>
    ...
    <div class="mx-auto max-w-2xl bg-white py-16 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <div class="space-y-24 lg:hidden">
        <section v-for="tier in tiers" :key="tier.name">
          ...
          <div class="border-t border-gray-200 px-6 pt-5 sm:px-4">
        ...
        <table class="h-px w-full table-fixed">
          ...
          <thead>
            <tr>
              ...
              <th v-for="tier in tiers" :key="tier.name" class="w-1/4 px-6 pb-4 text-left text-lg font-medium leading-6 text-gray-900" scope="col">
                {{ tier.name }}
              </th>
            </tr>
          </thead>
          <tbody class="divide-y divide-gray-200 border-t border-gray-200">
            <tr>
              <th class="py-8 pl-6 pr-6 text-left align-top text-sm font-medium text-gray-900" scope="row">
                Pricing
              </th>
            ...
            <template v-for="section in sections" :key="section.name">
              <tr>
                <th class="bg-gray-50 py-3 pl-6 text-left text-sm font-medium text-gray-900" colspan="4" scope="colgroup">
                  {{ section.name }}
                </th>
              </tr>
              <tr v-for="feature in section.features" :key="feature.name">
                <th class="py-5 pl-6 pr-6 text-left text-sm font-normal text-gray-500" scope="row">
                  {{ feature.name }}
                </th>
    ...
    <!-- Logo cloud -->
    <div class="mx-auto max-w-7xl border-t border-gray-200 py-12 px-6 lg:py-20 lg:px-8">
    ...
    <!-- Footer -->
    <footer class="mx-auto mt-12 max-w-7xl py-12 px-6 lg:py-16 lg:px-8">
      <h2 class="sr-only">
        Footer
      </h2>
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        ...
        <div class="mt-8 xl:mt-0">
          ...
          <form class="mt-4 sm:flex sm:max-w-md">
            ...
            <input id="email-address" type="email" name="email-address" autocomplete="email" required="" class="w-full min-w-0 rounded-md border-gray-300 bg-white py-2 px-4 placeholder-gray-500 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-500" placeholder="Enter your email">
            <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button type="submit" class="flex w-full items-center justify-center rounded-md border border-transparent bg-orange-100 py-2 px-4 text-base font-medium text-red-600 hover:bg-orange-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
                Subscribe
              </button>
            </div>
          </form>
