  ...
  <div class="bg-white">
    <div class="bg-gray-50">
          ...
          <div class="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            <PopoverGroup as="nav" class="hidden space-x-10 md:flex">
              <Popover v-slot="{ open }" class="relative">
                <PopoverButton class="group inline-flex items-center rounded-md bg-gray-50 text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2" :class="[open ? 'text-gray-900' : 'text-gray-500']">
                  <span>Solutions</span>
      ...
      <div class="mx-auto max-w-7xl py-16 px-6 sm:py-24 lg:px-8">
        <div class="text-center">
          <h1 class="text-lg font-semibold text-cyan-600">
            Pricing
          </h1>
    ...
    <div class="relative bg-white">
      ...
      <div class="relative mx-auto max-w-7xl lg:grid lg:grid-cols-2 lg:px-8">
        <div class="bg-white py-16 px-6 sm:py-24 lg:px-0 lg:pr-8">
          <div class="mx-auto max-w-lg lg:mx-0">
            <h2 class="text-lg font-semibold text-cyan-600">
              Full-featured
            </h2>
            <p class="mt-2 text-2xl font-bold text-gray-900 sm:text-3xl sm:tracking-tight">
        ...
        <div class="bg-gradient-to-r from-cyan-600 to-green-400 py-16 px-6 sm:py-24 lg:flex lg:items-center lg:justify-end lg:bg-none lg:px-0 lg:pl-8">
    ...
    <div class="bg-cyan-100 bg-opacity-25">
      <div class="mx-auto max-w-7xl py-16 px-6 sm:py-24 lg:px-8">
        <div class="lg:grid lg:grid-cols-2 lg:gap-8">
          <h2 class="mx-auto max-w-md text-center text-3xl font-bold tracking-tight text-cyan-900 lg:max-w-xl lg:text-left">
        ...
        <div class="space-y-4 border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between lg:space-y-0 xl:mt-0">
          ...
          <form class="sm:flex sm:max-w-md">
            ...
            <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button type="submit" class="flex w-full items-center justify-center rounded-md border border-transparent bg-gray-700 py-2 px-4 text-base font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-900">
                Subscribe
              </button>
            </div>
          </form>
