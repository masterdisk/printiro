...
<template>
  <div class="bg-white">
        ...
        <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
          ...
          <PopoverGroup as="nav" class="hidden space-x-10 md:flex">
            <Popover v-slot="{ open }" class="relative">
              <PopoverButton class="group inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" :class="[open ? 'text-gray-900' : 'text-gray-500']">
                <span>Solutions</span>
        ...
        <div class="border-t border-gray-200 pt-16 xl:grid xl:grid-cols-3 xl:gap-x-8">
          ...
          <div class="mt-4 sm:mt-8 md:mt-10 md:grid md:grid-cols-2 md:gap-x-8 xl:col-span-2 xl:mt-0">
            <ul role="list" class="divide-y divide-gray-200">
              <li v-for="(feature, featureIdx) in features.slice(0, 5)" :key="feature" class="py-4 flex" :class="[featureIdx === 0 ? 'md:py-0 md:pb-4' : '']">
            ...
            <ul role="list" class="divide-y divide-gray-200 border-t border-gray-200 md:border-t-0">
              <li v-for="(feature, featureIdx) in features.slice(5)" :key="feature" class="py-4 flex" :class="[featureIdx === 0 ? 'md:border-t-0 md:py-0 md:pb-4' : '']">
                <CheckIcon class="h-6 w-6 flex-shrink-0 text-green-500" aria-hidden="true" />
                <span class="ml-3 text-base text-gray-500">{{ feature }}</span>
              </li>
            </ul>
    ...
    <!-- Simple footer -->
    <footer class="mx-auto max-w-7xl overflow-hidden py-16 px-6 lg:px-8">
