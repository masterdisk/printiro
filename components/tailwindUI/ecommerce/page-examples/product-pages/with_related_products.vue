      ...
      <div class="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
          ...
          <div class="mt-4">
            ...
            <div class="flex items-center">
              ...
              <div class="ml-1 flex items-center">
                <StarIcon v-for="rating in [0, 1, 2, 3, 4]" :key="rating" class="h-5 w-5 flex-shrink-0" :class="[reviews.average > rating ? 'text-yellow-400' : 'text-gray-200']" aria-hidden="true" />
              </div>
        ...
        <div class="mt-8 lg:col-span-7 lg:col-start-1 lg:row-span-3 lg:row-start-1 lg:mt-0">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-3 lg:gap-8">
            <img v-for="image in product.images" :key="image.id" :src="image.imageSrc" :alt="image.imageAlt" class="rounded-lg" :class="[image.primary ? 'lg:col-span-2 lg:row-span-2' : 'hidden lg:block']">
          </div>
        </div>
          ...
          <div v-for="review in reviews.featured" :key="review.id" class="pt-10 lg:grid lg:grid-cols-12 lg:gap-x-8">
            <div class="lg:col-span-8 lg:col-start-5 xl:col-span-9 xl:col-start-4 xl:grid xl:grid-cols-3 xl:items-start xl:gap-x-8">
              <div class="flex items-center xl:col-span-1">
                <div class="flex items-center">
                  <StarIcon v-for="rating in [0, 1, 2, 3, 4]" :key="rating" class="h-5 w-5 flex-shrink-0" :class="[review.rating > rating ? 'text-yellow-400' : 'text-gray-200']" aria-hidden="true" />
                </div>
