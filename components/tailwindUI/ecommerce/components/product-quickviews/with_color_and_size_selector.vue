                    ...
                    <section aria-labelledby="information-heading" class="mt-2">
                      ...
                      <div class="mt-6">
                        ...
                        <div class="flex items-center">
                          <div class="flex items-center">
                            <StarIcon v-for="rating in [0, 1, 2, 3, 4]" :key="rating" class="h-5 w-5 flex-shrink-0" :class="[product.rating > rating ? 'text-gray-900' : 'text-gray-200']" aria-hidden="true" />
                          </div>
                          <p class="sr-only">
                          ...
                          <RadioGroup v-model="selectedSize" class="mt-4">
                            ...
                            <div class="grid grid-cols-4 gap-4">
                              <RadioGroupOption v-for="size in product.sizes" :key="size.name" v-slot="{ active, checked }" as="template" :value="size" :disabled="!size.inStock">
                                <div class="group relative border rounded-md py-3 px-4 flex items-center justify-center text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1" :class="[size.inStock ? 'bg-white shadow-sm text-gray-900 cursor-pointer' : 'bg-gray-50 text-gray-200 cursor-not-allowed', active ? 'ring-2 ring-indigo-500' : '']">
